...
function addTransformer(): void {
  // Though newer ts-jest versions support TS transformers, the legacy version does not.
...
/**
 * Skip tests which don't apply to Node than therefore don't need to run in older Node versions.
 *
